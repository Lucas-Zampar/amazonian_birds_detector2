...
def parse_data(dataset_type='extended_work_partial'):
    '''
    ...
    if dataset_type == 'extended_work_partial':
        images_dir = '../dataset/extended_work_partial_dataset/'
        annotations_dir = '../dataset/extended_work_partial_dataset/'

    if dataset_type == 'extended_work_total':
        images_dir = '../dataset/extended_work_total_dataset/'
        annotations_dir = '../dataset/extended_work_total_dataset/'
